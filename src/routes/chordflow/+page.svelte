<script lang="ts">
  ...
  function handleBarChange(bar: number) {
    advanceBar();
    ...
    if (chordFlowState.isChordChangeReady) {
      ...
      // Play chord audio on chord change
  ...
  function handleBeatChange(beat: number) {
    // Play chord audio on beat 1 if enabled and not beat-1-only mode
    if (chordAudioSettings.enabled && !chordAudioSettings.playOnBeat1Only && beat === 0) {
  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <header class="mb-8 text-center">
      ...
      <p class="text-gray-300 text-lg">
        Guitar chord progression practice with metronome
      </p>
    </header>
        ...
        <div class="lg:col-span-1">
          <div class="bg-gray-900 rounded-lg p-6 shadow-xl">
            <ChordDisplay 
              ...
              isChordChangeReady={chordFlowState.isChordChangeReady}
            />
          </div>
        </div>
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <p class="text-xs text-gray-500">
                How many bars to play each chord
              </p>
            </div>
          </div>
