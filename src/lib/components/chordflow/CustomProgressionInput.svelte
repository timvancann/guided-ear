    ...
    <div class="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
      ...
      <div class="flex flex-wrap gap-2">
        {#each parsedProgression.chords as parsedChord, index (index)}
          <span
            class="px-2 py-1 rounded text-xs font-mono {parsedChord.isValid
    ...
    <div class="bg-gray-800/30 rounded-lg p-4 border border-gray-700/50">
      ...
      <div class="space-y-3 text-xs text-gray-400">
        ...
        <div>
          ...
          <div class="mt-1">Major, minor (m), 7th, maj7, m7, sus2, sus4, dim, aug, add9, etc.</div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1 space-y-1">
            {#each examples as example (example)}
              <div>
                <button onclick={() => (inputText = example)} class="text-emerald-400 hover:text-emerald-300 font-mono text-xs underline">
                  {example}
                </button>
              </div>
            {/each}
