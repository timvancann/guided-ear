  ...
  <div class="space-y-3">
    ...
    >
      <div class="flex items-center space-x-3">
        <div class="w-4 h-4 rounded-full border-2 {selectedOption === 'incremental' ? 'border-emerald-500 bg-emerald-500' : 'border-gray-500'}"></div>
        <div>
          <h5 class="font-medium text-white">Incremental</h5>
          <p class="text-sm text-gray-400 mt-1">I → ii → iii → IV → V → vi → vii° → I (repeat)</p>
        </div>
      </div>
    </button>
    ...
    >
      <div class="flex items-center space-x-3">
        <div class="w-4 h-4 rounded-full border-2 {selectedOption === 'random' ? 'border-emerald-500 bg-emerald-500' : 'border-gray-500'}"></div>
        <div>
          <h5 class="font-medium text-white">Random</h5>
          <p class="text-sm text-gray-400 mt-1">Random selection from the 7 diatonic chords</p>
        </div>
      </div>
    </button>
  </div>
